<div class="container-fluid">
				...
				<table class="table table-bordered" id="student-tbl">
					<thead>
						<tr>
							...
							<th class="text-center">Student Typ</th>
	...
	<script>
		...
		window.load_tbl = function(){
			...
			$('#student-tbl tbody').html('<tr><td colspan="4" class="text-center">Please Wait...</td></tr>')
			$.ajax({
				...
				success:function(resp){
					if(typeof resp != undefined){
						...
						$('#student-tbl tbody').html('<tr><td colspan="4" class="text-center">No Data...</td></tr>')
						}
					}
				},
				complete:function(){
